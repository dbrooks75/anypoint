...
var questions = [
    ...
    { name: "Bond Expiration Date",
      choiceValue: null, dateValue: null, integerValue: null,
      responseText: null },
    { name: "Has said company ever had a wage and hour violation?",
      choiceValue: null, dateValue: null, integerValue: null,
      responseText: if ((vars.row.WageHrViol default "") == "Yes") "Yes" else "No" },
    { name: "Are the involved employees subject to collective bargaining?",
      choiceValue: null, dateValue: null, integerValue: null,
