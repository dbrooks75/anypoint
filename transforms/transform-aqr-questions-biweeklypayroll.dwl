...
// Computed once per row, before AddBusinessLicenseAppBiWeeklyPayroll — feeds both
// transform-bla-biweeklypayroll.dwl's Omni_JSON_Data__c and
// transform-assessment-question-response-biweeklypayroll.dwl's AQR creation. See
